$(document).ready(function () {
    ...
    //$("select#letterType").on('change', function () {
    //    selectedletter = $("#letterType").children("option:selected").val();
    //    console.log("here")
    //    //no selection
    //    if (selectedletter == "0") {
    //        $(".hide").hide();
    ...
    $("#createLetter").click(function () {
        ...
        //selectedletter = $('button').id;
        //selectedletter = $("#letterType").children("option:selected").val();
       // selectedGender = $("#gender").children("option:selected").val();
